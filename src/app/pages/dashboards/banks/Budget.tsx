...
// Filter transactions for Banking sector (sector_id: 1)
...
const monthlyData = bankingTransactions.reduce((acc, transaction) => {
      ...
      <div className="flex grow gap-5">
        <div className="flex w-1/2 flex-col">
          ...
          <p className="mt-2 line-clamp-3 text-xs leading-normal">
            Total chargeable: {formatCurrency(totalChargeable)}. Represent VAT from chargeable transaction volume for Banking sector.
          </p>
        </div>
