...
// New cell components for regional transactions
export function RegionCell({ getValue }: { getValue: Getter<any> }) {
  return (
    <span className="text-primary-600 dark:text-primary-400 font-medium">
      {getValue()}
    </span>
...
export function BusinessBranchCell({ getValue }: { getValue: Getter<any> }) {
  return (
    <span className="dark:text-dark-100 font-medium text-gray-800">
      {getValue()}
    </span>
...
export function NumericCell({ getValue }: { getValue: Getter<any> }) {
  return (
    <p className="text-sm-plus dark:text-dark-100 font-medium text-gray-800">
...
export function CurrencyCell({ getValue }: { getValue: Getter<any> }) {
  return (
    <p className="text-sm-plus dark:text-dark-100 font-medium text-gray-800">
      ₦{getValue().toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    </p>
