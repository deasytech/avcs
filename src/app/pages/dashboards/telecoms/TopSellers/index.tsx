...
import { useTelecomData } from "./useTelecomData";
...
const getBusinessAvatar = (businessName: string): string => {
  const avatarMap: Record<string, string> = {
    "Airtel": "/images/avatar/avatar-5.jpg", // Red theme
    "MTN": "/images/avatar/avatar-4.jpg",   // Yellow theme
    "Glo": "/images/avatar/avatar-6.jpg",   // Green theme
  };
...
export function TopSellers() {
  const telecomData = useTelecomData();

  const sellers: Seller[] = telecomData.map((business) => ({
