...
// Filter transactions for Hotels sector (sector_id: 4)
const hotelsTransactions = transactionsData.filter(
...
const monthlyData = hotelsTransactions.reduce((acc, transaction) => {
      ...
      <div className="flex grow gap-5">
        <div className="flex w-1/2 flex-col">
          ...
          <p className="mt-2 line-clamp-3 text-xs leading-normal">
            Total chargeable: {formatCurrency(totalChargeable)}. Represent VAT from chargeable transaction volume for Hotels sector.
          </p>
        </div>
